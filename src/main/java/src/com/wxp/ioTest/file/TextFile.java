package src.com.wxp.ioTest.file;//: net/mindview/util/TextFile.java
...
public class TextFile extends ArrayList<String> {
    ...
    public static void main(String[] args) {
        String file = read("D:\\IdealWorkspace\\javaProject\\src\\com\\wxp\\ioTest\\file\\TextFile.java");
        write("test.txt", file);
        TextFile text = new TextFile("test.txt");
        text.write("test2.txt");
        // Break into unique sorted list of words:
        TreeSet<String> words = new TreeSet<String>(
                new TextFile("D:\\IdealWorkspace\\javaProject\\src\\com\\wxp\\ioTest\\file\\TextFile.java", "\\W+"));
